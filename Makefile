# This Makefile is for the Term::Vspark extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Term/Vspark.pm]
#     AUTHOR => [q[Gil Gonçalves <lurst@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Term::Vspark]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Term/Vspark.pm]
...
PARENT_NAME = Term
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Term/Vspark.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Term/Vspark.pm

PM_TO_BLIB = lib/Term/Vspark.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Term/Vspark.pm $(INST_MAN3DIR)/Term::Vspark.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Perl extension for dispaying bars in the terminal'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Gil Gonçalves <lurst@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Term-Vspark' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Perl extension for dispaying bars in the terminal",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Gil Gonçalves <lurst@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Term-Vspark",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for dispaying bars in the terminal</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Gil Gonçalves &lt;lurst@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Term/Vspark.pm blib/lib/Term/Vspark.pm 
