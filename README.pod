...
The 'columns' parameter is the maximum width of the graph. This parameter is
optional.

The 'custom_char' parameter is the character we'll use to make the graph
instead of the utf8 characters. This parameter is optional.
...
at L<https://github.com/kablamo/term-vspark/issues>.
...
L<https://github.com/kablamo/term-vspark>
